...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        data = [CellData(name: "Hamlet", description: "Just Dies", date: "02 . 10 . 2019 12:34:23"),
                CellData(name: "Bamlet", description: "Goes out with a bam", date: "03 . 10 . 2019 18:12:56"),
                CellData(name: "Jamjamlet", description: "Death by Jam", date: "04 . 10 . 2019 23:01:02")]
...
//        if deathCell.frame.height < 60 {
//            deathCell.heightAnchor.constraint(equalToConstant: 80).isActive = true
//        }
        deathCell.sizeToFit()
